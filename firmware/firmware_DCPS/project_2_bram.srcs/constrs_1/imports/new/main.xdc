...
# create_clock -period 6.250 -name CLK_REF_P -waveform {0.000 3.125} -add [get_ports CLK_REF_P]



#BEAT CLOCKS with REFERENCE CLOCK
# #DDMTD0_Q1 ==> H1/G1 ==> CLKOUT0_0  ==> pin22/pin24 of JB302 ==> B65_L14_GC of FPGA
set_property PACKAGE_PIN L5 [get_ports {BEAT_REF1_N}]
set_property IOSTANDARD LVDS [get_ports {BEAT_REF1_N}]
set_property PACKAGE_PIN M6 [get_ports {BEAT_REF1_P}]
set_property IOSTANDARD LVDS [get_ports {BEAT_REF1_P}]

#H1/G1 ==> CLKOUT1_0 ==> pin51/pin53 of JB301 ==> B64_L12_GC of FPGA
set_property PACKAGE_PIN AF5 [get_ports {BEAT_REF2_N}]
set_property IOSTANDARD LVDS [get_ports {BEAT_REF2_N}]
set_property PACKAGE_PIN AE5 [get_ports {BEAT_REF2_P}]
set_property IOSTANDARD LVDS [get_ports {BEAT_REF2_P}]
...
# #========================
## #DDMTD0_Q1 ==> H1/G1 ==> CLKOUT0_0  ==> pin22/pin24 of JB302 ==> B65_L14_GC of FPGA
# set_property PACKAGE_PIN L5 [get_ports {BEAT_REF_N}]
# set_property IOSTANDARD LVDS [get_ports {BEAT_REF_N}]
# set_property PACKAGE_PIN M6 [get_ports {BEAT_REF_P}]
# set_property IOSTANDARD LVDS [get_ports {BEAT_REF_P}]
